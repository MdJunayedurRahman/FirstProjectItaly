  ...
  return (
    <div className="block">
      ...
      <div className="w-screen flex flex-col items-center gap-10 relative md:mb-20">
        <div className="info" style={{ padding: "10px 0" }}>
          <strong>Mr Pathan Sas</strong>
          <br />
          <b>Sede Legale e Operativa:</b> Via del Pilastro, 15-6 , 40127 Bologna
          - Bologna
          <br />
          <strong>Telefono:</strong> 3292121210
          <br />
          <strong>Fax:</strong>
          <br />
          <strong>Partita IVA:</strong> 02823441205
          <br />
        </div>
      </div>
      <div className="w-screen flex flex-col items-center gap-10 relative md:mb-20">
        ...
        <article className="block md:flex flex-col gap-5 w-full md:w-auto bg-white border border-lightgray rounded-lg md:pl-[56px] md:pt-[56px] md:pr-[90px]">
